...
public class FileHandler {
	...
	public ArrayList<String> getUserItems(String detail, String user){
		/*
		 * This method returns the items associated with Themes, Videos, and BGM. Specifically,
		 * it will show what items are present by the user - i.e, User: video1 video2, will return
		 * an ArrayList of video1 and video2.
		 */
		FileReader fileReader;
		try {
	...
	public void addPurchase(String user, String purchase, String type){
		/*
		 * This method adds a purchase to the user's text file.
		 */
