...
public class SceneMediator{;
    ...
    public void setSceneStyle(Scene scene){
    	...
    	if(_theme.equals("Pirate")){
    		scene.getStylesheets().add(getClass().getResource("PirateTheme.css").toExternalForm());
    	} else if (_theme.equals("Forest")){
    		scene.getStylesheets().add(getClass().getResource("MagicalForestTheme.css").toExternalForm());
    	}
    }
